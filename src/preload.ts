...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  showChecklistMainHeaderContextMenu: (payload: { taskId: number, sectionId: number, areAllComplete: boolean, isSectionOpen: boolean, isNotesHidden: boolean, isResponsesHidden: boolean, x: number, y: number, isInEditMode: boolean, isConfirmingDelete: boolean }) => ipcRenderer.send('show-checklist-main-header', payload),
  showChecklistSectionContextMenu: (payload: { taskId: number, sectionId: number, areAllComplete: boolean, isSectionOpen: boolean, isNotesHidden: boolean, isResponsesHidden: boolean, x: number, y: number, isInEditMode: boolean, isConfirmingDelete: boolean }) => ipcRenderer.send('show-checklist-section-context-menu', payload),
  showChecklistItemContextMenu: (payload: { taskId: number, sectionId: number, itemId: number, isCompleted: boolean, hasNote: boolean, hasResponse: boolean, hasUrl: boolean, isInEditMode: boolean, x: number, y: number }) => ipcRenderer.send('show-checklist-item-context-menu', payload),
